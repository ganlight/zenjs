...
views.blog__catalog__index_html = function() {/*<style>.banner-area{line-height:5rem}.banner-area .back-btn{background:currentColor}.banner-area .catalog-area{background:#5f9ea0}.articles-area{padding-top:5rem}.articles-area .article-item{display:block;margin:1rem;background:#f8f8ff;padding:1rem}.articles-area .article-item .title{padding-bottom:5px}</style><div class="zen-page"><div class="banner-area inline clearfix fix-top"><div class="back-btn span4" v-link="#index"><i class="fa fa-paper-plane fa-fw white"></i> <span class="white ml10 font16">ZENJS</span></div><div class="catalog-area span8 white font16"><div class="catalog-title">目录</div><ul class="catalog-list" style="display:none"></ul></div></div><ul class="articles-area"></ul><div class="page-template hide"><div class="article-item"><div class="font20 title"></div><div class="font16 gray"><span class="type"></span>/<span class="file"></span></div></div><div class="catalog-item"><span class="type_name"></span> <span class="type_num"></span></div></div></div><script v-script="views/blog/config.js"></script><script>$(function(){var t={articles:[],types:{},sections:null,map:{},init:function(){ZEN_ARTICLES&&(this.articles=ZEN_ARTICLES,this.pre(),this.rendType(this.types),this.rendArticles(this.articles))},pre:function(){var t=this;if(this.articles&&this.articles.length>0)for(var i=(this.articles.length,this.articles),e=0;e<i.length;e++){var a=i[e];a.id=e,t.types[a.type]||(t.types[a.type]=[]),t.types[a.type].push(a)}},rendType:function(t){var i=this;if(t){var e=$(".catalog-list");for(var a in t){var n=$(".page-template .catalog-item").clone();Store.data(n,t[a]),n.find(".type_name").text(a),n.attr("data-type",a),n.find(".type_num").text(t[a].length),i.bindType(n),e.append(n)}}},rendArticles:function(t){var i=this;if(t&&t.length>0){var e=(t.length,t),a=$(".articles-area");a.empty();for(var n=0;n<e.length;n++){var r=e[n],c=$(".page-template .article-item").clone();Store.data(c,r),Util.rendValue(c,r),i.bindArticle(c),a.append(c)}}},get:function(t,i){var e=this.map[t+"/"+i]||"";return e},bindType:function(t){var i=this;t.click(function(){var t=$(this).attr("data-type");if(t){var e=i.types[t];i.rendArticles(e)}})},bindArticle:function(t){t.click(function(){var i=Store.data(t);i&&i.id>-1&&(window.location.href="#blog/article?id="+i.id)})}},i={init:function(){this.data=t,t.init(),this.bind()},bind:function(){$(".catalog-area").click(function(){$(".catalog-list").toggle()})}};Zen.ready(i)})</script>*/}
