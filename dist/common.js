...
views.blog__catalog__index_html = function() {/*<style>.banner-area{line-height:5rem}.banner-area .back-btn{background:currentColor}.banner-area .catalog-area{background:#5f9ea0}.articles-area{padding-top:5rem}.articles-area .article-item{display:block;margin:1rem;background:#f8f8ff;padding:1rem}.articles-area .article-item .title{padding-bottom:5px}</style><div class="zen-page"><div class="banner-area inline clearfix fix-top"><div class="back-btn span4" v-link="#index"><i class="fa fa-paper-plane fa-fw white"></i> <span class="white ml10 font16">ZENJS</span></div><div class="catalog-area span8 white font16"><div class="catalog-title">目录</div><ul class="catalog-list"></ul></div></div><ul class="articles-area"></ul><div class="page-template hide"><div class="article-item"><div class="font20 title"></div><div class="font16 gray"><span class="type"></span>/<span class="file"></span></div></div><div class="catalog-item"><span class="type_name"></span> <span class="type_num"></span></div></div></div><script v-script="views/blog/config.js"></script><script>$(function(){var t={articles:[],types:[{type:"zenjs",type_name:"zenjs 目录"},{type:"life",type_name:"life 目录"}],sections:null,map:{},init:function(){articles&&(this.articles=articles,this.pre())},pre:function(){var t=this;if(this.articles&&this.articles.length>0)for(var e=(this.articles.length,this.articles),i=$(".articles-area"),a=0;a<e.length;a++){var n=e[a];n.id=a;var r=$(".page-template .article-item").clone();Store.data(r,n),t.map[n.type+"/"+n.file]=n,Util.rendValue(r,n),t.bindArticle(r),i.append(r)}},rendType:function(t){if(t)for(var e=(t.length,t),i=$(".catalog-list"),a=0;a<e.length;a++){var n=e[a],r=$(".page-template .catalog-item").clone();Store.data(r,n),Util.rendValue(r,n),i.append(r)}},rendArticles:function(t){var e=this;if(t&&t.length>0)for(var i=(t.length,t),a=$(".articles-area"),n=0;n<i.length;n++){var r=i[n],l=$(".page-template .article-item").clone();Store.data(l,r),Util.rendValue(l,r),e.bindArticle(l),a.append(l)}},get:function(t,e){var i=this.map[t+"/"+e]||"";return i},bindType:function(t){var e=this;t.click(function(){var i=Store.data(t);if(i&&i.type){var a=i.type,n=i.catalog[a];e.rendArticles(n)}})},bindArticle:function(t){t.click(function(){var e=Store.data(t);e&&e.id>-1&&(window.location.href="#blog/article?id="+e.id)})}},e={init:function(){t.init()}};Zen.ready(e)})</script>*/}
