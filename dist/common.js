...
views.blog__index_html = function() {/*<style>.markdown-area{margin-bottom:1.5rem}</style><div class="zen-page"><h2 class="font24 white text-center normal title"></h2><div class="markdown-area c-card"></div></div><script>$(function(){var n=[{title:"Zenjs install",date:"2016-11-25 14:00",auther:"ganlight",type:"zenjs",section:"begin",file:"begin-install"},{title:"Zenjs install2",date:"2016-11-25 14:00",auther:"ganlight",type:"zenjs",section:"begin",file:"begin-install"}],e={init:function(){MarkDown.init(),MarkDown.load(n[0])}};Zen.ready(e)})</script>*/}
