...
Zen.views.gradients__index_html = function() {/*<style>.zen-page{max-width:none}.card{position:absolute;width:90%;height:90%;background:#FFF;top:5%;left:5%;border-radius:.5rem}</style><div class="zen-page"><div class="card v-center"><div class="font24 name">card</div></div></div><script>$(function(){var n={ele:null,init:function(){var e=this.ele=$(".card");this.change(),n.reset(e),$(window).resize(function(){n.reset(e)}),this.bind()},reset:function(n,e){if(!e)var e=15;var i=window.innerWidth||document.body&&document.body.clientWidth,t=window.innerHeight||document.body&&document.body.clientHeight;this.width=i-2*e,this.height=t-2*e;var c={width:i-2*e,height:t-2*e,left:e,top:e};n.css(c)},change:function(){var n=zen.gradients,e=parseInt(Math.random()*n.length),i=n[e],t={background:i.colors[0],background:"linear-gradient(to left, "+i.colors[0]+", "+i.colors[1]+")"};this.ele.find(".name").text(i.name),this.ele.css(t)},bind:function(){this.ele.click(function(){n.change()})}},e={init:function(){n.init()},init_sidenav:function(){$(".c-navmenu-banner .menu").click(function(){SideNav.toggle("right")}),$(".c-navmenu-banner .logo").click(function(){SideNav.toggle("top")}),$(".c-side-nav .c-ul li").click(function(n){n.preventDefault(),SideNav.close(),zen.url.go($(this).attr("v-link"))})}};zen.page.ready(e)})</script>*/}
