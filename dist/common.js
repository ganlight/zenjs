...
Zen.views["design/index/index.html"] = function() {/*<div class="zen-page"><zen-slot name="layout/menu.html"></zen-slot><div class="container"><ul class="design-list clearfix inline"></ul></div><div class="template-area hide"><li class="design-item"><div class="content"><div class="design-header"><a><div class="overlay"></div><img src="assets/img/background.jpg"></a></div><div class="design-body"><ul class="tag-list"></ul><h2 class="title"></h2><h4 class="info"></h4></div></div></li></div><zen-slot name="layout/footer.html"></zen-slot></div><script v-script="views/design/config.js"></script><script>$(function(){var t={dom:null,data:null,init:function(){DESIGN_DIC&&(this.data=DESIGN_DIC,this.rend(this.data))},rend:function(t){console.log(t);for(var n=this,i=$(".design-list"),e=t.length,a=0;a<e;a++){var d=t[a],o=$(".template-area .design-item").clone();zen.store.data(o,d),o.find(".title").text(d.title),n.bind(o),i.append(o)}},bind:function(t){t.click(function(){var n=zen.store.data(t);window.location.hash="#design/index?hash="+n.title})}};t.init()})</script>*/}
...
Zen.views["design/index/index.css"] = function() {/*<style>.design-list{position:relative;margin:0 auto}.design-list .design-item{width:50%;display:inline-block;float:left;margin:0 auto;cursor:pointer}.design-item .content{position:relative;overflow:hidden;display:block;margin-bottom:30px;background:#fff;box-shadow:0 5px 10px 0 hsla(0,0%,57%,.1);margin:15px}.design-header{position:relative;overflow:hidden;max-height:200px;height:auto;width:100%}.design-header img{width:100%;max-width:100%;height:auto;vertical-align:middle;border:0}.design-header .overlay{width:100%;height:100%;background:-webkit-linear-gradient(270deg,rgba(0,0,0,.01) 2%,rgba(0,0,0,.95));background:-webkit-linear-gradient(top,rgba(0,0,0,.01) 2%,rgba(0,0,0,.95));background:linear-gradient(180deg,rgba(0,0,0,.01) 2%,rgba(0,0,0,.95));-webkit-transition:opacity .4s ease-in-out;transition:opacity .4s ease-in-out;position:absolute;opacity:0}.design-item:hover .overlay{opacity:.5}.design-body{margin:20px;position:relative;width:100%;max-height:90px;height:auto}.design-body h2{font-weight:300}.design-body h2:after{content:"";background-color:#19b5fe;left:0;width:50px;height:2px;bottom:-2px;position:absolute}.tag-list li{padding:4px 10px;background-color:#19b5fe;color:#fff;font-size:12px;line-height:1.4;font-weight:400;margin:0 5px 5px 0;border-radius:2px;display:inline-block;cursor:pointer}.tag-list li:nth-child(5n){background-color:#4a4a4a}.tag-list li:nth-child(5n+1){background-color:#ff5e5c}.tag-list li:nth-child(5n+2){background-color:#ffbb50}.tag-list li:nth-child(5n+3){background-color:#1ac756}.tag-list li:nth-child(5n+4){background-color:#19b5fe}.tag-list li:hover{background-color:#1b1b1b;color:#fff}</style>*/}
