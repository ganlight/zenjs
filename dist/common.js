...
views.blog__article__index_html = function() {/*<style>.banner-area{line-height:5rem}.banner-area .back-btn{background:currentColor}.banner-area .catalog-type{background:#5f9ea0}.markdown-area{position:relative;background:#fff;margin:1.5rem 1.5rem 0;border-radius:.3rem;padding:1.5rem;margin-bottom:6rem;display:none}</style><div class="zen-page"><div class="banner-area inline clearfix fix-bottom"><div class="back-btn span3"><i class="fa fa-arrow-left fa-fw white"></i><span class="white ml10 font16">上一篇</span></div><div class="catalog-type span6 white font16" v-link="#blog/catalog">目录</div><div class="back-btn span3"><span class="white mr10 font16">下一篇</span><i class="fa fa-arrow-right fa-fw white"></i></div></div><h2 class="font24 white text-center normal title"></h2><div class="markdown-area"></div><div class="catalog-area"></div><div class="page-template hide"><div class="list-item inline c-card clearfix"><div class="font20 title"></div><div class="font16 gray"><span class="type"></span>/<span class="file"></span></div></div></div></div><script v-script="views/blog/config.js"></script><script>$(function(){var MarkDown={converter:null,init:function(){if(showdown&&showdown.Converter){this.converter=new showdown.Converter;var e={};e.type=Util.getPar("type"),e.file=Util.getPar("file"),e.type&&e.file&&MarkDown.load(e)}else $(".title").html("暂不支持markdown")},rend:function(e,a){if(this.converter&&a){var t=this.converter.makeHtml(a);$(".title").html(e.title),$(".markdown-area").html(t).show()}},load:function(article){var self=this,url='views["blog/markdown/'+article.type+"/"+article.file+'.md"]',data=Zen.parse(eval(url));data&&(data=data.replace(/__block_head__/g,"/*"),self.rend(article,data))},load_file:function(e){var a=this,t="blog/"+e.type+"/"+e.file+".md";$.ajax({url:t,type:"get",async:!1,dataType:"html",success:function(t){$(".catalog-area").hide(),$(".markdown-area").show(),a.rend(e,t)},error:function(a){$(".markdown-area").hide(),$(".catalog-area").show(),Message.toast("当前文章"+e.file+"不存在，请返回其他文章")}})}},Service={init:function(){MarkDown.init()}};Zen.ready(Service)})</script>*/}
views.blog__catalog__index_html = function() {/*<style>#app{background:#3f554f}.banner-area{line-height:5rem}.banner-area .back-btn{background:currentColor}.banner-area .catalog-type{background:#5f9ea0}.catalog-area{padding-top:5rem}.catalog-area .list-item{display:block;margin:1rem;background:#f8f8ff;padding:1rem}.catalog-area .list-item .title{padding-bottom:5px}</style><div class="zen-page"><div class="banner-area inline clearfix fix-top"><div class="back-btn span4" v-link="#index"><i class="fa fa-paper-plane fa-fw white"></i><span class="white ml10 font16">ZENJS</span></div><div class="catalog-type span8 white font16">目录</div></div><ul class="catalog-area"></ul><div class="page-template hide"><div class="list-item"><div class="font20 title"></div><div class="font16 gray"><span class="type"></span>/<span class="file"></span></div></div></div></div><script v-script="views/blog/config.js"></script><script>$(function(){var t={articles:[],types:null,sections:null,map:{},init:function(){articles&&(this.articles=articles,this.rend())},rend:function(){var t=this;if(this.articles&&this.articles.length>0)for(var i=(this.articles.length,this.articles),e=$(".catalog-area"),n=0;n<i.length;n++){var a=i[n],l=$(".page-template .list-item").clone();Store.data(l,a),t.map[a.type+"/"+a.file]=a,Util.rendValue(l,a),t.bind(l),e.append(l)}},get:function(t,i){var e=this.map[t+"/"+i]||"";return e},bind:function(t){t.click(function(){var i=Store.data(t);i&&i.file&&(window.location.href="#blog/article?type="+i.type+"&file="+i.file)})}},i={init:function(){t.init()}};Zen.ready(i)})</script>*/}
