...
Zen.views.douban__index_html = function() {/*<style></style><div class="zen-page"><div class="info"></div></div><script src="https://api.douban.com/v2/book/1220562" id="test" type="text/template"></script><script>$(function(){var n={init:function(){}},i={init:function(){n.init()}};zen.page.ready(i)})</script>*/}
