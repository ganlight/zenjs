...
Zen.views["design/index.html"] = function() {/*<style>.design-list{position:relative;margin:0 auto}.design-list .design-item{max-width:50%;display:inline-block;float:left;margin:0 auto}.design-item .content{position:relative;overflow:hidden;display:block;margin-bottom:30px;background:#FFF;-webkit-box-shadow:0 5px 10px 0 rgba(146,146,146,.1);-moz-box-shadow:0 5px 10px 0 rgba(146,146,146,.1);box-shadow:0 5px 10px 0 rgba(146,146,146,.1);margin:15px}.design-header{position:relative;overflow:hidden;max-height:200px;height:auto;width:100%}.design-header img{max-width:100%;height:auto;vertical-align:middle;border:0}.design-header .overlay{width:100%;height:100%;background:-webkit-linear-gradient(270deg,rgba(0,0,0,.01) 2%,rgba(0,0,0,.95) 100%);background:linear-gradient(180deg,rgba(0,0,0,.01) 2%,rgba(0,0,0,.95) 100%);-webkit-transition:opacity .4s ease-in-out;transition:opacity .4s ease-in-out;position:absolute;opacity:0}.design-header:hover .overlay{opacity:.5}.design-body{margin:20px;position:relative}.design-body h2{font-weight:300}.design-body h2::after{content:"";background-color:#19B5FE;left:0;width:50px;height:2px;bottom:-2px;position:absolute}.tag-list li{padding:4px 10px;background-color:#19B5FE;color:#fff;font-size:12px;line-height:1.4;font-weight:400;margin:0 5px 5px 0;border-radius:2px;display:inline-block;cursor:pointer}.tag-list li:nth-child(5n){background-color:#4A4A4A}.tag-list li:nth-child(5n+1){background-color:#ff5e5c}.tag-list li:nth-child(5n+2){background-color:#ffbb50}.tag-list li:nth-child(5n+3){background-color:#1ac756}.tag-list li:nth-child(5n+4){background-color:#19B5FE}.tag-list li:hover{background-color:#1B1B1B;color:#FFF}</style><div class="zen-page"><zen-slot name="layout/menu.html"></zen-slot><div class="container"><ul class="design-list clearfix inline"><li class="design-item"><div class="content"><div class="design-header"><a><div class="overlay"></div><img src="https://ooo.0o0.ooo/2017/03/10/58c189da36d5b.jpg"></a></div><div class="design-body"><ul class="tag-list"><li>web</li><li>html</li><li>icon</li></ul><h2 class="title">12款优质简洁的个人简历打包下载</h2><h4 class="info"></h4></div></div></li><li class="design-item"><div class="content"><div class="design-header"><a><div class="overlay"></div><img src="https://ooo.0o0.ooo/2017/03/10/58c189da36d5b.jpg"></a></div><div class="design-body"><ul class="tag-list"><li>web</li><li>html</li><li>icon</li></ul><h2 class="title">12款优质简洁的个人简历打包下载</h2><h4 class="info"></h4></div></div></li></ul></div><div class="template-field"></div><zen-slot name="layout/footer.html"></zen-slot></div>*/}
