...
zen.dao=function(){var e=$(".zen-container");if(Zen.views.zen_modules){var n=zen.parse(Zen.views.zen_modules),s=$("<div>").addClass("zen-modules");s.append(n),e.append(s)}if(Zen.views.zen_css){var a=zen.parse(Zen.views.zen_css);$("title").after(a)}if(Zen.views.common_css){var i=zen.parse(Zen.views.common_css);$("head").append(i)}if(Zen.views.common_js){var d=zen.parse(Zen.views.common_js);$("head").append(d)}var v=$("<div>").addClass("zen-stack zen-cur clearfix");e.append(v)};
...
.zen-container{-webkit-transition:all .2s;transition:all .2s}.zen-page,.zen-stack{position:relative;-webkit-transition:all .2s;transition:all .2s}.zen-page{max-width:1024px;margin:0 auto;width:100%;min-height:100%}.zen-module{display:none}.zen-module.show{display:block}
