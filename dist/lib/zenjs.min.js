...
.zen-container,.zen-stack{position:absolute;width:100%;height:100%;top:0;left:0;overflow-y:auto}.zen-stack{-webkit-transition:all .2s;transition:all .2s}.zen-page{position:relative;max-width:1024px;margin:0 auto;width:100%;min-height:100%}.zen-module{display:none}.zen-module.show{display:block}
