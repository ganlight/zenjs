...
zen.dao={init:function(){$(document).ready(function(){zen.dao.zen(),zen.page.init(),zen.fastclick(),$(window).on("hashchange",function(){zen.url.getHash()||"index";zen.page.init()})})},zen:function(){var e=$(".zen-container");if(this.isDebug=zen.store.gLocal("ZEN_DEBUG")||!1,Zen.modules){var n=zen.parse(Zen.modules),a=$("<div>").addClass("zen-modules");a.append(n),e.append(a)}if(Zen.css){var s=zen.parse(Zen.css);$("title").after(s)}if(Zen.views.common_css){var i=zen.parse(Zen.views.common_css);$("head").append(i)}if(Zen.views.common_js){var o=zen.parse(Zen.views.common_js);$("head").append(o)}var d=$("<div>").addClass("zen-stack zen-cur");e.append(d)}};
zen.debug=function(e){var n="normal";"debug"==e&&(n="debug"),zen.store.sLocal("ZEN_DEBUG",n),Zen.mode=n};
...
zen.page={mode:"normal",fastclick:!1,animate:"",init:function(){console.time("load"),delete Zen.current;var e=zen.url.getHash()||"index";console.log("###Zen enter : "+e),this.enterAni(this.animate),this.load_view(),this.load_module(),this.load_script(),console.timeEnd("load")},enterAni:function(e){e&&$(".zen-cur").addClass(e+" animated").one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",function(){$(this).removeClass(e+" animated")})},getModule:function(type){var module="",hash=zen.url.getHash()||"index",name="Zen.views."+zen.url.pathname(hash)+"_"+type,name_index="Zen.views."+zen.url.pathname(hash)+"__index_"+type;return eval(name)?(module=zen.parse(eval(name)),console.log("Zen module : "+name),module):eval(name_index)?(module=zen.parse(eval(name_index)),console.log("Zen module : "+name),module):void 0},load_view:function(){console.time("load_view");var e,t,n,a="";e=this.getModule("css"),t=this.getModule("html"),n=this.getModule("js"),e&&(a+=e),t&&(a+=t),n&&("debug"==this.isDebug?this.debug_script():(a+=n,this.debug_clear())),a&&($(".zen-container").removeClass("mask-on nav-top nav-right"),$(".zen-cur").html(a)),console.timeEnd("load_view")},load_module:function(){console.time("load_module");var e=$(".zen-container");e.find("*[v-zen]").each(function(){var e=$(this),t=$(this).attr("v-zen");if(t){var n=$(".zen-modules .c-"+t).clone();e.html(n)}}),$("*[v-insert]").each(function(){var e=$(this),t=$(this).attr("v-insert");if(t){var n=t+".html";$.ajax({url:n,type:"get",async:!1,dataType:"html",success:function(t){e.html(t)}})}}),$("*[v-slot]").each(function(){var e=$(this),t=$(this).attr("v-slot");t&&e.html($("#"+t))}),$("*[v-send]").click(function(){var e=$(this).attr("v-send");if(e){var t=e.split(",");zen.message.send(t[0],t[1],t[2])}}),$("*[v-select]").click(function(){var e=$(this).attr("v-select");e&&zen.message.select("",e)}),$("*[v-toggle]").click(function(){var e=$(this).attr("v-toggle");e&&($("#"+e).toggle(),$(this).toggleClass("selected"))}),$("*[v-link]").click(function(){var e=$(this).attr("v-link");e&&(window.location.href=e)}),$(".zen-page").attr("data-ready","ready"),console.timeEnd("load_module")},load_script:function(href){var head=$("head");head.find("*[data-type='page-script']").remove();for(var items=$("*[v-script]"),i=0;i<items.length;i++){var item=items.eq(i),clone=$("<script>").attr("type","text/javascript");if(item&&item.attr("v-script")){var script_src=item.attr("v-script");if(script_src.indexOf("views")==-1)clone.attr("src",script_src),clone.attr("data-type","page-script"),head.append(clone),item.remove();else{var script_name=zen.url.pathname(script_src).replace("views__","Zen.views.");script=zen.parse(eval(script_name)),item.after(script),item.remove()}}}},debug_clear:function(){var e=$("head");e.find("*[data-type='debug-script']").remove()},debug_script:function(){var e="views/"+zen.url.getHash()+"/index.js",t=$("head");t.find("*[data-type='debug-script']").remove();var n=$("<script>").attr("type","text/javascript");n.attr("src",e),n.attr("data-type","debug-script"),t.append(n)},parse:function(e){if("function"==typeof e){var t=e.toString();if(t.length>20)return t.slice(15,-3)}},delay:function(e){return"ready"==$(".zen-page").attr("data-ready")?void(e&&e()):(console.log("Zen delay : 5ms"),void setTimeout(function(){zen.page.delay(e)},5))},ready:function(e){console.time("ready");var t=zen.url.getHash()||"index";this.delay(function(){e&&e.init&&e.init(),zen.cur=e||t,console.log("***Zen ready : "+t)}),console.timeEnd("ready")}};
zen.parse=function(n){if("function"==typeof n){var t=n.toString();if(t.length>20)return t.slice(15,-3)}};
...
var zm=Zen.modules,zv=Zen.views,zd=Zen.data,zt=Zen.template,zen=Zen.common;zen.dao.init();
...
.zen-container,.zen-stack{position:absolute;width:100%;height:100%;top:0;left:0;overflow-y:auto;-webkit-transition:all .2s;transition:all .2s}.zen-page{position:relative;max-width:1024px;margin:0 auto;width:100%;min-height:100%;-webkit-transition:all .2s;transition:all .2s}.zen-module{display:none}.zen-module.show{display:block}
