...
zen.dao=function(){var e=$(".zen-container");if(this.isDebug=zen.store.gLocal("ZEN_DEBUG")||!1,Zen.modules){var n=zen.parse(Zen.modules),s=$("<div>").addClass("zen-modules");s.append(n),e.append(s)}if(Zen.css){var a=zen.parse(Zen.css);$("title").after(a)}if(Zen.views.common_css){var d=zen.parse(Zen.views.common_css);$("head").append(d)}if(Zen.views.common_js){var o=zen.parse(Zen.views.common_js);$("head").append(o)}var i=$("<div>").addClass("zen-stack zen-cur");e.append(i)};
...
zen.directive={init:function(){var t=$(".zen-container");t.find("*[v-zen]").each(function(){var t=$(this),e=$(this).attr("v-zen");if(e){var n=$(".zen-modules .c-"+e).clone();t.html(n)}}),$("*[v-insert]").each(function(){var t=$(this),e=$(this).attr("v-insert");if(e){var n=e+".html";$.ajax({url:n,type:"get",async:!1,dataType:"html",success:function(e){t.html(e)}})}}),$("*[v-slot]").each(function(){var t=$(this),e=$(this).attr("v-slot");if(e)if($("#"+e).length)t.html($("#"+e));else{var n=zen.content(e+".html");t.html(n)}}),$("*[v-send]").click(function(){var t=$(this).attr("v-send");if(t){var e=t.split(",");zen.message.send(e[0],e[1],e[2])}}),$("*[v-select]").click(function(){var t=$(this).attr("v-select");t&&zen.message.select("",t)}),$("*[v-toggle]").click(function(){var t=$(this).attr("v-toggle");t&&($("#"+t).toggle(),$(this).toggleClass("selected"))}),$("*[v-link]").click(function(){var t=$(this).attr("v-link");t&&(window.location.href=t)})}};
