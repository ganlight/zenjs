...
zen.resize=function(){$(".screen-height").css("min-height",$(window).height()),$(".zen-container").css("min-height",$(window).height()),$(".zen-page").css("min-height",$(window).height()),$(window).resize(function(){$(".screen-height").css("min-height",$(window).height()),$(".zen-container").css("min-height",$(window).height()),$(".zen-page").css("min-height",$(window).height())})};
zen.scroll={to:function(o,t){return t||(t=300),o?o.length>0&&$("html,body").animate({scrollTop:$(o).offset().top},t):$("html,body").animate({scrollTop:0},t),!1}};
...
.zen-page{position:relative;max-width:1024px;margin:0 auto;width:100%;min-height:100%;-webkit-transition:all .2s;transition:all .2s}.zen-module{display:none}.zen-module.show{display:block}
