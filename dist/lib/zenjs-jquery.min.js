...
zen.parse=function(e){function n(e){return e.replace(/__block_head__/g,"/*").replace(/__block_foot__/g,"*/"),e}if("function"==typeof e){var t=e.toString();if(t.length>20)return n(t.slice(15,-3))}return""},zen.content=function(path){var content="";path.indexOf("views/")>-1&&(path=path.replace("views/",""));var script_name='Zen.views["'+path+'"]';return content=zen.parse(eval(script_name))};
