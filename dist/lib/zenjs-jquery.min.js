...
zen.dao=function(){var e=$(".zen-container");if(Zen.views.zen_modules){var n=zen.parse(Zen.views.zen_modules),s=$("<div>").addClass("zen-modules");s.append(n),e.append(s)}if(Zen.views.zen_css){var a=zen.parse(Zen.views.zen_css);$("title").after(a)}if(Zen.views.common_css){var d=zen.parse(Zen.views.common_css);$("head").append(d)}if(Zen.views.common_js){var i=zen.parse(Zen.views.common_js);$("head").append(i)}var v=$("<div>").addClass("zen-stack zen-cur");e.append(v)};
